...
const schema = z.object({
    ...
    password: z.string().min(8, {message: 'Password should have minimum 8 characters!'}),
    confirmPassword: z.string(), // 
    deliveryAddress: z.string().min(15, {message: 'Please Enter Valid Address'})
}).refine(data => data.password === data.confirmPassword, {message: 'ConfirmPassword should match password!', path: ['confirmPassword']})
            ...
            <form className='authentication_form signup_form' onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='image_input_section'>
                    <div className='image_preview'>
                        <img src={profilePic != null ? URL.createObjectURL(profilePic) : user} id='file-ip-1-preview' />
                    </div>
